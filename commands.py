...
def setup(tree):
    ...
    @tree.command(name="twitch_list", description="List all usernames in the database.", guild=Object(id=flg))
    ...
    @tree.command(name="twitch_channel", description="Update the Twitch alert channel.", guild=Object(id=flg))
    ...
    @tree.command(name="twitch_role", description="Update the Twitch ping role.", guild=Object(id=flg))
    ...
    @tree.command(name="twitch_ping", description="Enable or disable Twitch pings.", guild=Object(id=flg))
    ...
    @tree.command(name="twitch_enable", description="Enable or disable Twitch alerts.", guild=Object(id=flg))
